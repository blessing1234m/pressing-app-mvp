                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="mt-8 p-4 border border-gray-200 rounded-lg">
                        ...
                        <div class="flex space-x-2">
                            <input type="text" placeholder="Nom du vêtement" class="flex-1 border border-gray-300 rounded-md px-3 py-2">
                            <input type="number" placeholder="Prix" min="0" class="w-24 border border-gray-300 rounded-md px-3 py-2">
